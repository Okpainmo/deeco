              ...
              <div className="flex items-center justify-evenly flex-col lg:flex-row py-12 w-full xl:w-[70%] ">
                <div className="bg-white rounded-md shadow-md w-[90%] lg:w-[46%] lg:h-[220px]  p-6">
                  ...
                  <p className="text-sm lg:text-base font-normal leading-6">
                    ...
                    platform empowers you to sell digital products with ease. From eBooks to
                    software, your success story starts here.
                  </p>
                </div>
                <div className="bg-white rounded-md shadow-md w-[90%] mt-4 lg:mt-0 lg:w-[46%] lg:h-[220px] p-6">
                  ...
                  <p className="text-sm lg:text-base font-normal leading-6">
                    Elevate your store's aesthetics with our stunning themes. Crafted for
                    conversions, our themes seamlessly blend style and functionality. Make a lasting
                    impression on your customers from the moment they land on your site.
                  </p>
                </div>
              </div>
            </div>
